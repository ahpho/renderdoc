...
copy /Y "%OutDir%sl.interposer.dll" "%InstallDir%工具在这里\《燕云十六声》PC版\"
copy /Y "%OutDir%sl.interposer.pdb" "%InstallDir%工具在这里\《燕云十六声》PC版\"
copy /Y "%OutDir%d3d11.dll" "%InstallDir%工具在这里\《燕云十六声》PC版\"
copy /Y "%OutDir%d3d11.pdb" "%InstallDir%工具在这里\《燕云十六声》PC版\"
copy /Y "%OutDir%dxgi.dll" "%InstallDir%工具在这里\《燕云十六声》PC版\"
copy /Y "%OutDir%dxgi.pdb" "%InstallDir%工具在这里\《燕云十六声》PC版\"
copy /Y "%OutDir%senderdod.dll" "%InstallDir%工具在这里\《燕云十六声》PC版\"
copy /Y "%OutDir%senderdod.pdb" "%InstallDir%工具在这里\《燕云十六声》PC版\"
